...
(defparameter *baseregles_pathologie*
  '((R1 ((eq sexe homme) (> Hematies 5500000) (eq sejour_altitude non )) (eq pathologie Polyglobulie))
    ...
    (R10 ((eq sexe homme) (eq pathologie Anemie) (< Hemoglobine 13) (< VGM 80)) (eq pathologie Anemie_microcytaire))
    ...
    (R46 ((eq sexe femme) (eq pathologie Anemie) (< Hemoglobine 13) (< VGM 80)) (eq pathologie Anemie_microcytaire))
